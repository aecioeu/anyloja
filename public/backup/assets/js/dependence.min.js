 ...
 */
!function(i){i.fn.magnify=function(t){t=i.extend({src:"",speed:100,timeout:-1,touchBottomOffset:0,finalWidth:null,finalHeight:null,magnifiedWidth:null,magnifiedHeight:null,limitBounds:!1,mobileCloseEvent:"touchstart",afterLoad:function(){}},t);var e=this,n=i("html"),o=0,a=function(){clearTimeout(o),o=setTimeout((function(){e.destroy(),e.magnify(t)}),100)};return this.destroy=function(){return this.each((function(){var t=i(this),e=t.prev("div.magnify-lens"),n=t.data("originalStyle");t.parent("div.magnify").length&&e.length&&(n?t.attr("style",n):t.removeAttr("style"),e.remove())})),i(window).off("resize",a),e},i(window).resize(a),this.each((function(){!function(e){var o=i(e),a=o.closest("a"),s={};for(var l in t)s[l]=o.attr("data-magnify-"+l.toLowerCase());var r=s.src||t.src||a.attr("href")||"";if(r){var d,f,c,h,m,g,u,p=function(){var i=d.offset();return u={top:o.offset().top-i.top+parseInt(o.css("border-top-width"))+parseInt(o.css("padding-top")),left:o.offset().left-i.left+parseInt(o.css("border-left-width"))+parseInt(o.css("padding-left"))},i.top+=u.top,i.left+=u.left,i},v=function(){f.is(":visible")&&f.fadeOut(t.speed,(function(){n.removeClass("magnifying").trigger("magnifyend")}))};isNaN(+s.speed)||(t.speed=+s.speed),isNaN(+s.timeout)||(t.timeout=+s.timeout),isNaN(+s.finalWidth)||(t.finalWidth=+s.finalWidth),isNaN(+s.finalHeight)||(t.finalHeight=+s.finalHeight),isNaN(+s.magnifiedWidth)||(t.magnifiedWidth=+s.magnifiedWidth),isNaN(+s.magnifiedHeight)||(t.magnifiedHeight=+s.magnifiedHeight),"true"===s.limitBounds&&(t.limitBounds=!0),"function"==typeof window[s.afterLoad]&&(t.afterLoad=window[s.afterLoad]),/\b(Android|BlackBerry|IEMobile|iPad|iPhone|Mobile|Opera Mini)\b/.test(navigator.userAgent)?isNaN(+s.touchBottomOffset)||(t.touchBottomOffset=+s.touchBottomOffset):t.touchBottomOffset=0,o.data("originalStyle",o.attr("style"));var y=new Image;i(y).on({load:function(){o.css("display","block"),o.parent(".magnify").length||o.wrap('<div class="magnify"></div>'),d=o.parent(".magnify"),o.prev(".magnify-lens").length?d.children(".magnify-lens").css("background-image","url('"+r+"')"):o.before('<div class="magnify-lens loading" style="background:url(\''+r+"') 0 0 no-repeat\"></div>"),(f=d.children(".magnify-lens")).removeClass("loading"),t.finalWidth||o.width(),t.finalHeight||o.height(),c=t.magnifiedWidth||y.width,h=t.magnifiedHeight||y.height,f.width(),f.height(),p(),t.limitBounds,c===y.width&&h===y.height||f.css("background-size",c+"px "+h+"px"),o.data("zoomSize",{width:c,height:h}),d.data("mobileCloseEvent",s.mobileCloseEvent||t.mobileCloseEvent),y=null,t.afterLoad(),f.is(":visible")&&v(),d.off().on({"mousemove touchmove":v,mouseenter:function(){p()},mouseleave:v}),t.timeout>=0&&d.on("touchend",(function(){setTimeout(v,t.timeout)})),i("body").not(d).on("touchstart",v);var e=o.attr("usemap");if(e){var n=i("map[name="+e.slice(1)+"]");o.after(n),d.click((function(t){if(t.clientX||t.clientY){f.hide();var e=document.elementFromPoint(t.clientX||t.originalEvent.touches[0].clientX,t.clientY||t.originalEvent.touches[0].clientY);"AREA"===e.nodeName?e.click():i("area",n).each((function(){var t=i(this).attr("coords").split(",");if(m>=t[0]&&m<=t[2]&&g>=t[1]&&g<=t[3])return this.click(),!1}))}}))}a.length&&(a.css("display","inline-block"),!a.attr("href")||s.src||t.src||a.click((function(i){i.preventDefault()})))},error:function(){y=null}}),y.src=r}}(this)}))}}(jQuery),
/*!
 ...
 * Read a copy of the license in the LICENSE file or at https://choosealicense.com/licenses/mit/
 */
function(i){i.fn.magnify&&(i('<style>.lens-mobile {position:fixed;top:0;left:0;width:100%;height:100%;background:#ccc;display:none;overflow:scroll;-webkit-overflow-scrolling:touch;z-index:9999;}.magnify-mobile>.close {position:fixed;left:50%;bottom: 80px;transform: translate(-50%, -50%);margin: 0 auto;background:#333;border-radius:50px;padding: 12px 23px;color:#fff;display:inline-block;font:normal bold 20px/32px "Google Sans",sans-serif;letter-spacing:0;opacity:0.8;text-align:center;text-shadow:none;z-index:99999;}@media only screen and (min-device-width:320px) and (max-device-width:773px) {/* Assume QHD (1440 x 2560) is highest mobile resolution */.lens-mobile { display:block; }}</style>').appendTo("head"),i(window).on("load",(function(){i("body").append('<div class="magnify-mobile"><div class="lens-mobile"></div></div>');var t=i(".lens-mobile");if(t.is(":visible")&&("ontouchstart"in window||window.DocumentTouch&&document instanceof DocumentTouch||navigator.msMaxTouchPoints)){var e=i(".magnify"),n=i(".magnify-mobile");e.off(),n.hide().append('<i class="close">FECHAR ZOOM</i>'),n.children(".close").on(e.data("mobileCloseEvent"),(function(){n.toggle()})),e.children("img").on({touchend:function(){if(!i(this).data("drag")){var e=i(this).data("scrollOffset");n.toggle(),t.scrollLeft(e.x),t.scrollTop(e.y)}},touchmove:function(){i(this).data("drag",!0)},touchstart:function(e){t.html('<img src="'+i(this).prev(".magnify-lens").css("background-image").replace(/url\(["']?|["']?\)/g,"")+'" alt="">');var n=i(this),o=n.data("zoomSize"),a=(e.originalEvent.touches[0].pageX-n.offset().left)/n.width(),s=(e.originalEvent.touches[0].pageY-n.offset().top)/n.height();n.data("scrollOffset",{x:o.width*a-window.innerWidth/2,y:o.height*s-window.innerHeight/2}),i(this).data("drag",!1)}})}})))}(jQuery);