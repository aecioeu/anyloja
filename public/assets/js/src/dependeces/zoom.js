            ...
            init = function(el) {
                ...
                $(elZoomImage).on({
                    'load': function() {
                        ...
                        if ($lens.is(':visible')) hideLens();
                        // Handle mouse movements
                        $container.off().on({
                            //alterado
                            'mousemove touchmove': hideLens,
                            'mouseenter': function() {
...
(function($) {
    ...
    $('<style>' +
        ...
        'font:normal bold 20px/32px "Google Sans",sans-serif;' +
        'letter-spacing:0;' +
        'opacity:0.8;' +
        'text-align:center;' +
        'text-shadow:none;' +
    ...
    $(window).on('load', function() {
        ...
        if ($lensMobile.is(':visible') && !!('ontouchstart' in window || (window.DocumentTouch && document instanceof DocumentTouch) || navigator.msMaxTouchPoints)) {
            ...
            $magnifyMobile.hide().append('<i class="close">FECHAR ZOOM</i>');
