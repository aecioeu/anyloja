...
(function() {
    ...
    this.Story = function() {
        ...
        var baseHTML = '<div class="storytime" style="opacity: 0; display: none; z-index: 999999;">' +
            ...
            '</div>' +
            `</div>
            <div class="story"><div class="story-video" onclick="socialStory.next();">
        ...
        <div class="text-center"><a href="#" class="story-link"><i class="fas fa-chevron-circle-up"></i><span><span>
        </a>
        </div>
        </div>
    ...
    async function CreateTemplate(src) {
        ...
        if (['mp4', 'avi'].includes(GetFilename(src))) {
            ...
            video.oncanplay = function() {
                ...
                //if (defaults.playlist[start].href) document.getElementsByClassName('story-link')[0].setAttribute('href', defaults.playlist[start].href);
                //else document.getElementsByClassName('story-link')[0].remove();
